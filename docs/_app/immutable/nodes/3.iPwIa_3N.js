import"../chunks/CYU6waRM.js";import{a2 as q,a4 as e,X as i,Y as o}from"../chunks/CIbDuVN7.js";import{f as t,a as r}from"../chunks/Cj25N8Tq.js";import{M as S,E as j,A as w,S as P,T as M,C as k,L as E,a as T,b as D}from"../chunks/Df5djvwU.js";var C=t(`<section><h2>Proyectos Realizados</h2> <p class="m-3 italic svelte-18za2o0">A continuación, un listado de los proyectos que de alguna manera se
    relacionan con el nuevo rumbo que busco para mi carrera profesional.</p> <article><h3 class="svelte-18za2o0">Indoor Monitor IoT <i class="fa-regular fa-star text-xs ml-2"></i></h3> <p class="svelte-18za2o0"><i class="fa-brands fa-github"></i> kodexArg/dj-indoor-monitor</p> <p class="svelte-18za2o0">API REST y aplicación web en producción desarrollada con <b>Django 5</b> + <b>DRF</b> que 
      ...
      ambos los he montado con éxito. Hago énfasis en los flujos de automatizaciones.</p> <p class="svelte-18za2o0"><strong>keywords:</strong>n8n, mcp, automation workflows, llm, ai orchestration</p></article></section>`);function L(s){var a=C();r(s,a)}var I=t(`<section class="svelte-vvbryx"><h2>Experiencia Laboral</h2> <article class="svelte-vvbryx"><h3 class="svelte-vvbryx">Grupo AVS: "Líder de Soporte Técnico"</h3> <span class="svelte-vvbryx">Diciembre 2016 - Presente</span> <p>Grupo AVS es un conglomerado de empresas, entre las que destacan <b>Casino de Mendoza</b> y una de las estaciones de servicio orientada a tránsito pesado más grande
      ...
      central.</p> <div><h4>Mis funciones</h4> <ul class="svelte-vvbryx"><li>Liderar a trabajadores IT interno.</li> <li>Diseñar diferentes infreastructuras de red.</li> <li>Arquitectar conexión de sitios muy diversos con la administración
          central y las nubes AWS y Azure.</li> <li>Mantenimiento, seguridad y supervisión de sistemas en la nube.</li> <li>Contratación de proveedores (ISP, telefonía, activos).</li> <li>Capacitaciones a otros trabajadores del grupo.</li> <li>Visibilizar y diseñar soluciones informáticas para otras áreas.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-vvbryx"><li>Gestión integral de la nube AWS (luego de pasar por Huawei y Azure).</li> <li>Automatización de tareas en la nube: Lambda.</li> <li>Interconexión con sitios on-premise</li> <li>De Fortigate a Mikrotik</li></ul></div> <p>En esta etapa descubrí y me enamoré de la *Nube* y aprendí muchísimo sobre
      la interconexión y seguridad entre diferentes sitios</p></article> <article class="svelte-vvbryx"><h3 class="svelte-vvbryx">Mendoza Central Entretenimiento S.A.:<br/>"Jefe de Organización y
      Sistemas"</h3> <span class="svelte-vvbryx">2005 - Diciembre 2016</span> <p>La empresa prestaba servicio de Tragamonedas, incluyendo la
      ...
      parametrización y ubicación en la sala.</p> <div><h4>Mis funciones</h4> <ul class="svelte-vvbryx"><li>Analítica de Datos <ul class="svelte-vvbryx"><li>Extracción de datos desde Forward System para análisis en tiempo
              ...
              decisiones.</li></ul></li> <li>Parametrización de Slots <ul class="svelte-vvbryx"><li>Participación activa en la parametrización de slots, incluyendo
              ...
              análisis de rendimiento.</li> <li>Contacto directo con fabricantes.</li></ul></li> <li>Sistemas e Infraestructura <ul class="svelte-vvbryx"><li>Diseño de red para 700 slots con alta disponibilidad (Switches
              ...
              backup y recuperación.</li></ul></li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-vvbryx"><li>Manejo de big data y analytics para toma de decisiones estratégicas.</li> <li>Integración de múltiples data sources para análisis 360° del negocio.</li> <li>Automatización y scripting para optimizar procesos de data analytics
          (Python).</li> <li>Desarrollo de habilidades en Business Intelligence, logística y
          gestión de proyectos.</li></ul></div> <p>En esta etapa descubrí y me enamoré de <b>Python</b></p></article> <article class="svelte-vvbryx"><h3 class="svelte-vvbryx">Casino Buenos Aires:<br/>"Técnico de Tragamonedas / Área Sistemas"</h3> <span class="svelte-vvbryx">2003 - 2005</span> <p>Fui la segunda persona a cargo de la sala (casino) de Rivadavia, donde
      aprendí y capacité a otros en la configuración de tragamonedas y en
      brindar soluciones de sistemas.</p> <div><h4>Mis funciones</h4> <ul class="svelte-vvbryx"><li>Soporte de Sistemas.</li> <li>Soporte a otras salas del grupo (varios kilómetros de distancia): en
          San Martín, Alvear y Malargüe.</li> <li>Reparación y mantenimiento de edificios.</li> <li>Parametrización de slots.</li> <li>Tareas de recaudación de dinero.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-vvbryx"><li>Desarrollo de habilidades de liderazgo como segundo a cargo en la
          sala.</li> <li>Profundización en la configuración de slots.</li> <li>Inicio en la gestión de sistemas y soporte técnico.</li></ul></div></article> <article class="svelte-vvbryx"><h3 class="svelte-vvbryx">Casino Buenos Aires: "Asistente de Tragamonedas"</h3> <span class="svelte-vvbryx">Octubre de 2002 - 2003</span> <p>Trabajé en San Martín de Mendoza en un casino recién formado, integrando
      un equipo reducido junto a compañeros y gerentes que se convirtieron en
      compañeros de vida por muchos años.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-vvbryx"><li>Conocimientos sobre el funcionamiento interno e integral de un casino y
        sus sistemas.</li></ul></article> <article class="svelte-vvbryx"><h3 class="svelte-vvbryx">Duek 2000: "Técnico de sistemas"</h3> <span class="svelte-vvbryx">Octubre de 2099 - 2002</span> <p>Trabajé armando computadoras, y en la última etapa desarrollando sitios web, utilizando IIS + ASP.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-vvbryx"><li>Conocimientos sobre hardware.</li> <li>Inicio en desarrollo web.</li> <li>Mis primeras nociones en redes e internet.</li></ul></article></section>`);function B(s){var a=I();r(s,a)}var V=t('<!> <!> <main class="background flex flex-col space-y-6 svelte-1yzrgel"><section class="a4 svelte-1yzrgel"><div class="flex w-full h-full content-wrapper"><div class="left-col bg-mate-100 rounded-l-md flex flex-col p-4 space-y-4 svelte-1yzrgel"><!> <!></div> <div class="right-col flex flex-col p-4 space-y-1 svelte-1yzrgel"><!> <!> <!> <!> <!> <!> <!></div></div></section></main>',1);function O(s){var a=V(),l=q(a);S(l);var c=e(l,2);j(c);var d=e(c,2),p=i(d),u=i(p),n=i(u),m=i(n);w(m);var x=e(m,2);P(x),o(n);var v=e(n,2),g=i(v);M(g);var y=e(g,2);k(y);var b=e(y,2);E(b);var h=e(b,2);T(h);var z=e(h,2);B(z);var f=e(z,2);D(f);var A=e(f,2);L(A),o(v),o(u),o(p),o(d),r(s,a)}export{O as component};
