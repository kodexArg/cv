import{s as U,n as P}from"../chunks/scheduler.54e97ece.js";import{S as J,i as K,g as k,h as M,z as X,a as B,f as g,k as E,r as l,s as v,u as c,c as f,j as C,v as d,y as o,d as p,t as u,w as m}from"../chunks/index.7d173593.js";import{M as Y,A as Z,S as ee,T as ae,C as se,L as ie,a as te,b as oe}from"../chunks/MaximizeButton.d409904c.js";function ne(D){let a,n=`<h2>Proyectos Realizados</h2> <p class="m-3 italic svelte-favtxo">A continuación, un listado de los proyectos que de alguna manera se
    relacionan con el nuevo rumbo que busco para mi carrera profesional.</p> <article><h3 class="svelte-favtxo">Indoor Monitor IoT <i class="fa-regular fa-star text-xs ml-2"></i></h3> <p class="svelte-favtxo"><i class="fa-brands fa-github"></i> kodexArg/dj-indoor-monitor
      <span class="ml-3 svelte-favtxo"><i class="fa-solid fa-link"></i> <a href="https://kcbd.grupoalvs.com" target="_blank" rel="noopener">kcbd.grupoalvs.com</a></span></p> <p class="svelte-favtxo">API REST y aplicación web en producción desarrollada con <b>Django 5</b> + <b>DRF</b> que 
      ...
      tensorflow, machine learning, matplotlib</p></article> <article><h3 class="svelte-favtxo">Estudios y prácticas recientes</h3> <h4 class="svelte-favtxo">Stable Diffusion</h4> <p class="svelte-favtxo">En el ámbito de la inteligencia artificial, he realizado una investigación
      ...
      comfyui, Midjurney</p></article>`;return{c(){a=k("section"),a.innerHTML=n},l(s){a=M(s,"SECTION",{"data-svelte-h":!0}),X(a)!=="svelte-v0f7x8"&&(a.innerHTML=n)},m(s,r){B(s,a,r)},p:P,i:P,o:P,d(s){s&&g(a)}}}class re extends J{constructor(a){super(),K(this,a,null,ne,U,{})}}function le(D){let a,n=`<h2>Experiencia Laboral</h2> <article class="svelte-16j369f"><h3>Grupo AVS: “Líder de Soporte Técnico”</h3> <span class="svelte-16j369f">Diciembre 2016 - Presente</span> <p>Grupo AVS es un conglomerado de empresas, entre las que destacan <b>Casino de Mendoza</b>
      ...
      central.</p> <div><h4>Mis funciones</h4> <ul class="svelte-16j369f"><li>Liderar a trabajadores IT interno.</li> <li>Diseñar diferentes infreastructuras de red.</li> <li>Arquitectar conexión de sitios muy diversos con la administración
          central y las nubes AWS y Azure.</li> <li>Mantenimiento, seguridad y supervisión de sistemas en la nube.</li> <li>Contratación de proveedores (ISP, telefonía, activos).</li> <li>Capacitaciones a otros trabajadores del grupo.</li> <li>Visibilizar y diseñar soluciones informáticas para otras áreas.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-16j369f"><li>Gestión integral de la nube AWS (luego de pasar por Huawei y Azure).</li> <li>Automatización de tareas en la nube: Lambda.</li> <li>Interconexión con sitios on-premise</li> <li>De Fortigate a Mikrotik</li></ul></div> <p>En esta etapa descubrí y me enamoré de la *Nube* y aprendí muchísimo sobre
      la interconexión y seguridad entre diferentes sitios</p></article> <article class="svelte-16j369f"><h3>Mendoza Central Entretenimiento S.A.:<br/>“Jefe de Organización y
      Sistemas”</h3> <span class="svelte-16j369f">2005 - Diciembre 2016</span> <p>La empresa prestaba servicio de Tragamonedas, incluyendo la
      ...
      parametrización y ubicación en la sala.</p> <div><h4>Mis funciones</h4> <ul class="svelte-16j369f"><li>Analítica de Datos <ul class="svelte-16j369f"><li>Extracción de datos desde Forward System para análisis en tiempo
              ...
              decisiones.</li></ul></li> <li>Parametrización de Slots <ul class="svelte-16j369f"><li>Participación activa en la parametrización de slots, incluyendo
              ...
              análisis de rendimiento.</li> <li>Contacto directo con fabricantes.</li></ul></li> <li>Sistemas e Infraestructura <ul class="svelte-16j369f"><li>Diseño de red para 700 slots con alta disponibilidad (Switches
              ...
              backup y recuperación.</li></ul></li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-16j369f"><li>Manejo de big data y analytics para toma de decisiones estratégicas.</li> <li>Integración de múltiples data sources para análisis 360° del negocio.</li> <li>Automatización y scripting para optimizar procesos de data analytics
          (Python).</li> <li>Desarrollo de habilidades en Business Intelligence, logística y
          gestión de proyectos.</li></ul></div> <p>En esta etapa descubrí y me enamoré de <b>Python</b></p></article> <article class="svelte-16j369f"><h3>Casino Buenos Aires:<br/>“Técnico de Tragamonedas / Área Sistemas”</h3> <span class="svelte-16j369f">2003 - 2005</span> <p>Fui la segunda persona a cargo de la sala (casino) de Rivadavia, donde
      aprendí y capacité a otros en la configuración de tragamonedas y en
      brindar soluciones de sistemas.</p> <div><h4>Mis funciones</h4> <ul class="svelte-16j369f"><li>Soporte de Sistemas.</li> <li>Soporte a otras salas del grupo (varios kilómetros de distancia): en
          San Martín, Alvear y Malargüe.</li> <li>Reparación y mantenimiento de edificios.</li> <li>Parametrización de slots.</li> <li>Tareas de recaudación de dinero.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-16j369f"><li>Desarrollo de habilidades de liderazgo como segundo a cargo en la
          sala.</li> <li>Profundización en la configuración de slots.</li> <li>Inicio en la gestión de sistemas y soporte técnico.</li></ul></div></article> <article class="svelte-16j369f"><h3>Casino Buenos Aires: “Asistente de Tragamonedas”</h3> <span class="svelte-16j369f">Octubre de 2002 - 2003</span> <p>Trabajé en San Martín de Mendoza en un casino recién formado, integrando
      un equipo reducido junto a compañeros y gerentes que se convirtieron en
      compañeros de vida por muchos años.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-16j369f"><li>Conocimientos sobre el funcionamiento interno e integral de un casino y
        sus sistemas.</li></ul></article> <article class="svelte-16j369f"><h3>Duek 2000: “Técnico de sistemas”</h3> <span class="svelte-16j369f">Octubre de 2099 - 2002</span> <p>Trabajé armando computadoras, y en la última etapa desarrollando sitios web, utilizando IIS + ASP.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-16j369f"><li>Conocimientos sobre hardware.</li> <li>Inicio en desarrollo web.</li> <li>Mis primeras nociones en redes e internet.</li></ul></article>`;return{c(){a=k("section"),a.innerHTML=n,this.h()},l(s){a=M(s,"SECTION",{class:!0,"data-svelte-h":!0}),X(a)!=="svelte-9bj1ke"&&(a.innerHTML=n),this.h()},h(){E(a,"class","svelte-16j369f")},m(s,r){B(s,a,r)},p:P,i:P,o:P,d(s){s&&g(a)}}}class ce extends J{constructor(a){super(),K(this,a,null,le,U,{})}}function de(D){let a,n,s,r,y,h,b,V,x,R,i,$,F,j,H,z,O,q,W,A,G,w,N,S,_;return a=new Y({}),b=new Z({}),x=new ee({}),$=new ae({}),j=new se({}),z=new ie({}),q=new te({}),A=new ce({}),w=new oe({}),S=new re({}),{c(){l(a.$$.fragment),n=v(),s=k("main"),r=k("section"),y=k("div"),h=k("div"),l(b.$$.fragment),V=v(),l(x.$$.fragment),R=v(),i=k("div"),l($.$$.fragment),F=v(),l(j.$$.fragment),H=v(),l(z.$$.fragment),O=v(),l(q.$$.fragment),W=v(),l(A.$$.fragment),G=v(),l(w.$$.fragment),N=v(),l(S.$$.fragment),this.h()},l(e){c(a.$$.fragment,e),n=f(e),s=M(e,"MAIN",{class:!0});var T=C(s);r=M(T,"SECTION",{class:!0});var Q=C(r);y=M(Q,"DIV",{class:!0});var I=C(y);h=M(I,"DIV",{class:!0});var L=C(h);c(b.$$.fragment,L),V=f(L),c(x.$$.fragment,L),L.forEach(g),R=f(I),i=M(I,"DIV",{class:!0});var t=C(i);c($.$$.fragment,t),F=f(t),c(j.$$.fragment,t),H=f(t),c(z.$$.fragment,t),O=f(t),c(q.$$.fragment,t),W=f(t),c(A.$$.fragment,t),G=f(t),c(w.$$.fragment,t),N=f(t),c(S.$$.fragment,t),t.forEach(g),I.forEach(g),Q.forEach(g),T.forEach(g),this.h()},h(){E(h,"class","left-col bg-mate-100 rounded-l-md flex flex-col p-4 space-y-4 svelte-vbehsk"),E(i,"class","right-col flex flex-col p-4 space-y-1 svelte-vbehsk"),E(y,"class","flex w-full h-full content-wrapper"),E(r,"class","a4 svelte-vbehsk"),E(s,"class","background flex flex-col space-y-6 svelte-vbehsk")},m(e,T){d(a,e,T),B(e,n,T),B(e,s,T),o(s,r),o(r,y),o(y,h),d(b,h,null),o(h,V),d(x,h,null),o(y,R),o(y,i),d($,i,null),o(i,F),d(j,i,null),o(i,H),d(z,i,null),o(i,O),d(q,i,null),o(i,W),d(A,i,null),o(i,G),d(w,i,null),o(i,N),d(S,i,null),_=!0},p:P,i(e){_||(p(a.$$.fragment,e),p(b.$$.fragment,e),p(x.$$.fragment,e),p($.$$.fragment,e),p(j.$$.fragment,e),p(z.$$.fragment,e),p(q.$$.fragment,e),p(A.$$.fragment,e),p(w.$$.fragment,e),p(S.$$.fragment,e),_=!0)},o(e){u(a.$$.fragment,e),u(b.$$.fragment,e),u(x.$$.fragment,e),u($.$$.fragment,e),u(j.$$.fragment,e),u(z.$$.fragment,e),u(q.$$.fragment,e),u(A.$$.fragment,e),u(w.$$.fragment,e),u(S.$$.fragment,e),_=!1},d(e){e&&(g(n),g(s)),m(a,e),m(b),m(x),m($),m(j),m(z),m(q),m(A),m(w),m(S)}}}class ve extends J{constructor(a){super(),K(this,a,null,de,U,{})}}export{ve as component};
