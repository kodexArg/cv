import"../chunks/BBa9aJRv.js";import{a2 as j,X as i,a4 as e,Y as o}from"../chunks/TCY0EtXJ.js";import{f as n,a as r}from"../chunks/BkHNFyQM.js";import{M as w,A as z,S as A,T as S,C as P,L as M,a as k,b as T}from"../chunks/CDO_bT5M.js";var D=n(`<section><h2>Proyectos Realizados</h2> <p class="m-3 italic svelte-favtxo">A continuación, un listado de los proyectos que de alguna manera se
    relacionan con el nuevo rumbo que busco para mi carrera profesional.</p> <article><h3 class="svelte-favtxo">Indoor Monitor IoT <i class="fa-regular fa-star text-xs ml-2"></i></h3> <p class="svelte-favtxo"><i class="fa-brands fa-github"></i> kodexArg/dj-indoor-monitor</p> <p class="svelte-favtxo">API REST y aplicación web en producción desarrollada con <b>Django 5</b> + <b>DRF</b> que 
      ...
      ambos los he montado con éxito. Hago énfasis en los flujos de automatizaciones.</p> <p class="svelte-favtxo"><strong>keywords:</strong>n8n, mcp, automation workflows, llm, ai orchestration</p></article></section>`);function E(s){var a=D();r(s,a)}var C=n(`<section class="svelte-190cwjq"><h2>Experiencia Laboral</h2> <article class="svelte-190cwjq"><h3>Grupo AVS: “Líder de Soporte Técnico”</h3> <span class="svelte-190cwjq">Diciembre 2016 - Presente</span> <p>Grupo AVS es un conglomerado de empresas, entre las que destacan <b>Casino de Mendoza</b> y una de las estaciones de servicio orientada a tránsito pesado más grande
      ...
      central.</p> <div><h4>Mis funciones</h4> <ul class="svelte-190cwjq"><li>Liderar a trabajadores IT interno.</li> <li>Diseñar diferentes infreastructuras de red.</li> <li>Arquitectar conexión de sitios muy diversos con la administración
          central y las nubes AWS y Azure.</li> <li>Mantenimiento, seguridad y supervisión de sistemas en la nube.</li> <li>Contratación de proveedores (ISP, telefonía, activos).</li> <li>Capacitaciones a otros trabajadores del grupo.</li> <li>Visibilizar y diseñar soluciones informáticas para otras áreas.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-190cwjq"><li>Gestión integral de la nube AWS (luego de pasar por Huawei y Azure).</li> <li>Automatización de tareas en la nube: Lambda.</li> <li>Interconexión con sitios on-premise</li> <li>De Fortigate a Mikrotik</li></ul></div> <p>En esta etapa descubrí y me enamoré de la *Nube* y aprendí muchísimo sobre
      la interconexión y seguridad entre diferentes sitios</p></article> <article class="svelte-190cwjq"><h3>Mendoza Central Entretenimiento S.A.:<br/>“Jefe de Organización y
      Sistemas”</h3> <span class="svelte-190cwjq">2005 - Diciembre 2016</span> <p>La empresa prestaba servicio de Tragamonedas, incluyendo la
      ...
      parametrización y ubicación en la sala.</p> <div><h4>Mis funciones</h4> <ul class="svelte-190cwjq"><li>Analítica de Datos <ul class="svelte-190cwjq"><li>Extracción de datos desde Forward System para análisis en tiempo
              ...
              decisiones.</li></ul></li> <li>Parametrización de Slots <ul class="svelte-190cwjq"><li>Participación activa en la parametrización de slots, incluyendo
              ...
              análisis de rendimiento.</li> <li>Contacto directo con fabricantes.</li></ul></li> <li>Sistemas e Infraestructura <ul class="svelte-190cwjq"><li>Diseño de red para 700 slots con alta disponibilidad (Switches
              ...
              backup y recuperación.</li></ul></li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-190cwjq"><li>Manejo de big data y analytics para toma de decisiones estratégicas.</li> <li>Integración de múltiples data sources para análisis 360° del negocio.</li> <li>Automatización y scripting para optimizar procesos de data analytics
          (Python).</li> <li>Desarrollo de habilidades en Business Intelligence, logística y
          gestión de proyectos.</li></ul></div> <p>En esta etapa descubrí y me enamoré de <b>Python</b></p></article> <article class="svelte-190cwjq"><h3>Casino Buenos Aires:<br/>“Técnico de Tragamonedas / Área Sistemas”</h3> <span class="svelte-190cwjq">2003 - 2005</span> <p>Fui la segunda persona a cargo de la sala (casino) de Rivadavia, donde
      aprendí y capacité a otros en la configuración de tragamonedas y en
      brindar soluciones de sistemas.</p> <div><h4>Mis funciones</h4> <ul class="svelte-190cwjq"><li>Soporte de Sistemas.</li> <li>Soporte a otras salas del grupo (varios kilómetros de distancia): en
          San Martín, Alvear y Malargüe.</li> <li>Reparación y mantenimiento de edificios.</li> <li>Parametrización de slots.</li> <li>Tareas de recaudación de dinero.</li></ul> <h4>Mi aprendizaje</h4> <ul class="svelte-190cwjq"><li>Desarrollo de habilidades de liderazgo como segundo a cargo en la
          sala.</li> <li>Profundización en la configuración de slots.</li> <li>Inicio en la gestión de sistemas y soporte técnico.</li></ul></div></article> <article class="svelte-190cwjq"><h3>Casino Buenos Aires: “Asistente de Tragamonedas”</h3> <span class="svelte-190cwjq">Octubre de 2002 - 2003</span> <p>Trabajé en San Martín de Mendoza en un casino recién formado, integrando
      un equipo reducido junto a compañeros y gerentes que se convirtieron en
      compañeros de vida por muchos años.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-190cwjq"><li>Conocimientos sobre el funcionamiento interno e integral de un casino y
        sus sistemas.</li></ul></article> <article class="svelte-190cwjq"><h3>Duek 2000: “Técnico de sistemas”</h3> <span class="svelte-190cwjq">Octubre de 2099 - 2002</span> <p>Trabajé armando computadoras, y en la última etapa desarrollando sitios web, utilizando IIS + ASP.</p> <h4>Mi aprendizaje</h4> <ul class="svelte-190cwjq"><li>Conocimientos sobre hardware.</li> <li>Inicio en desarrollo web.</li> <li>Mis primeras nociones en redes e internet.</li></ul></article></section>`);function L(s){var a=C();r(s,a)}var I=n('<!> <main class="background flex flex-col space-y-6 svelte-lqd86n"><section class="a4 svelte-lqd86n"><div class="flex w-full h-full content-wrapper"><div class="left-col bg-mate-100 rounded-l-md flex flex-col p-4 space-y-4 svelte-lqd86n"><!> <!></div> <div class="right-col flex flex-col p-4 space-y-1 svelte-lqd86n"><!> <!> <!> <!> <!> <!> <!></div></div></section></main>',1);function _(s){var a=I(),l=j(a);w(l);var c=e(l,2),d=i(c),p=i(d),t=i(p),u=i(t);z(u);var x=e(u,2);A(x),o(t);var m=e(t,2),v=i(m);S(v);var f=e(v,2);P(f);var g=e(f,2);M(g);var y=e(g,2);k(y);var b=e(y,2);L(b);var h=e(b,2);T(h);var q=e(h,2);E(q),o(m),o(p),o(d),o(c),r(s,a)}export{_ as component};
